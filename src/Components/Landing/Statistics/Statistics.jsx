...
export const Statistics = () => {
  return (
    ...
    >
      ...
      <div className="mt-[20px] text-[16px] text-[#7E7E7E] dark:text-Dark_TextColor_2">متن مرتبط</div>
      <div className="mt-[140px] flex flex-nowrap justify-center gap-[100px]">
        ...
        <div>
          <span className="StNumbers dark:text-Dark_TextColor_1">۷۸ </span>
          <span className="StTexts dark:text-Dark_TextColor_1">دوره آموزشی</span>
        </div>
        <div>
