...
export const Course = () => {
  return (
    <div
      className="cotainer mt-[800px] md:w-[1300px] h-[800px] m-auto md:mt-[480px] text-right mb-10"
      dir="rtl"
      data-aos="fade-down"
    >
      <div className="h-[800px] mt-72 text-right mb-10" dir="rtl">
        ...
        <div className="2xl:w-4/5 xl:w-4/6 lg:w-3/5 md:w-1/2 mx-auto mt-10 translate-x-[15px]">
          <img
