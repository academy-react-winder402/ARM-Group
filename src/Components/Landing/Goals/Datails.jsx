...
export const Deatails = () => {
  return (
    <>
      <div className="w-1/2 text-center mx-auto md:pr-20">
        <Subject
      ...
      <div className="h-[650px] flex flex-col gap-y-16 items-center xl:grid gap-x-52 grid-cols-2 grid-rows-5 text-3xl text-center">
        <div className="h-[200px] w-[510px] col-start-1 row-span-2">
          <div className="flex">
            <img
              className="h-28"
              ...
              alt="استعداد یابی"
            />
            <h3 className="mt-20 mr-4 text-xl font-light text-textColor dark:text-Dark_TextColor_1">
              استعداد یابی
            </h3>
          </div>
          <p className="text-[#7E7E7E] text-base text-right mt-4 leading-8">
        ...
        <div className="h-[200px] w-[510px] col-start-2 row-start-2 row-span-2">
          <div className="flex">
            <img
              className="h-28"
        ...
        <div className="h-[200px] w-[510px] col-start-1 row-start-3 row-span-2">
          <div className="flex">
            <img
              className="h-28"
        ...
        <div className="h-[200px] w-[510px] col-start-2 row-start-4 row-span-2">
          <div className="flex">
            <img
              className="h-28"
