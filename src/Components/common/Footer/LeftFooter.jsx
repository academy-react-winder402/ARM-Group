...
const LeftFooter = () => {
  return (
    <div className='mt-[50px] w-[400px] h-[320px] float-left'>
      <div className='text-center text-[25px] text-[#5E5E5E]'>ارتباط با ما</div>
      <div className='text-[16px] text-center mt-[20px]'>پذیرای هر گونه پیشنهاد، انتقاد و پاسخگوی سوالات شما هستیم</div>
