    ...
    <div className="w-[87.5%] mx-auto mt-[40px] pt-[1rem] bg-[#F3F3F3]" style={{direction: 'rtl'}}>
        ...
        <div className='h-[95px] pt-[10px] mt-[115px]'>
            <div className='w-[44%] h-[100%] float-right'>
                <h1 className='mt-[-10px] text-[24px] text-[#5E5E5E] font-bold'>خلاصه وضعیت دوره</h1>
                <div className='mt-[10px]'>
                    <p className='float-right text-[#7E7E7E] font-medium xxx'>درصد انجام تمارین: ۷۸٪ </p>
            ...
            <div className='w-[56%] h-[100%] float-right text-[14px] text-[#6E6E6E]'>
                <div className='flex flex-row flex-nowrap mr-[100px]'>
                    <div className='flex flex-row flex-nowrap'><span className=''>تعداد روز های دوره</span><span>۲۳۰</span><span>روز</span></div>
                    <div className='w-[231.5px] h-[4px] mt-[8px] mr-[3px] rounded-[1rem] bg-[#DBDBDB] overflow-hidden'><div className='bg-[#69EECE] w-[50%] h-[100%] float-left'></div></div>
                    <div className='flex flex-row flex-nowrap gap-[5px]'><span>روز‌های باقی مانده</span><span>۸۰</span><span>روز</span></div>
                </div>
                <div className='flex flex-row flex-nowrap mt-[15px] mr-[100px]'>
                    <div className='flex flex-row flex-nowrap'><span>شهریه دوره</span><span>۴.۲۰۰.۰۰۰</span><span>تومان</span></div>
                    <div className='w-[231.5px] h-[4px] mt-[12px] mr-[3px] rounded-[1rem] bg-[#DBDBDB] overflow-hidden'><div className='bg-[#F3DD6D] w-[50%] h-[100%] float-left'></div></div>
                    <div className='flex flex-row flex-nowrap'><span>باقی‌مانده شهریه</span><span>۲.۱۰۰.۰۰۰</span>تومان<span></span></div>
                </div>
            </div>
        </div>
