...
import { EmailValidation, PasswordValidation } from "../../Core/Validations/login.validation";
...
function MainForm() {
  ...
  const SendCodeHandler = () => {
    if (EmailPhone === "" || Password === ""){
      ...
      if((EmailValidation(EmailPhone) || PhoneValidation(EmailPhone)) && PasswordValidation(Password)){
